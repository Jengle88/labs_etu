 ...
 * 10) заменить возвращаемые значения 1 и 0 на константы
 * 11) добавить в код комментарии
 * 12) добавить повторение запроса команд до опции "выход"
 * 13) добавить функцию "очистить терминал"
 * 14) заменить calloc на malloc, где это нужно
*/
